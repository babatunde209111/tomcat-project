...
something you can run it like this too
#sh debug.sh >output.log 2 >output.error 

or 

sh debug.sh 1> output.log 2>output.error

sh debug.sh > output.log 2>output.error 

You can also use this command to cat the file 

[cat output.log && cat output.error] 
this will show the contect of the two file together 
